...
const ProductInfo:FC<{item:ProductInterface}> = ({item}) => {
  ...
  return (
    <Link href={`/AllProductsInfo/${item._id}`}>
    <div className="max-w-xl rounded overfflow-hidden bg-[#E5E4E2] md:flex-col flex shadow-lg  hover:scale-105  hover:duration-300 hover:ease-linear ">
