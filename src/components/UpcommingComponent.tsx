...
const UpcommingComponent:FC<{item:ProductInterface}> = ({item}) => {
  ...
  return (
   <Link href={`/ProductsInfo/${item._id}`}>
    <div className="max-w-xl rounded overflow-hidden bg-[#E5E4E2] md:flex-col flex-col flex shadow-lg  hover:scale-105 md:hover:scale-125  hover:duration-300 hover:ease-linear ">
